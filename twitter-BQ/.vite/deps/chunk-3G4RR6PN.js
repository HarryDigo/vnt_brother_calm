import {
  ...
  WindowContext,
  require_browser,
  useSlotProps_default as useSlotProps_default2
...
function Notification({
  ...
  const snackbarSlotProps = useSlotProps_default2({
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(React25.Fragment, {
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(React30.Fragment, {
...
var FormControl = React32.forwardRef(function FormControl2(props, forwardedRef) {
  const {
    defaultValue,
    children,
    disabled = false,
...
var Input = React35.forwardRef(function Input2(props, forwardedRef) {
  const {
...
function useList(params) {
  ...
  const getItemState = React37.useCallback((item) => {
...
var ListContext = React38.createContext(null);
if (true) {
...
function useCompoundParent() {
  ...
  const registerItem = React40.useCallback(function registerItem2(id, item) {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = React42.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT;
...
var Portal = React45.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React45.useState(null);
  const handleRef = useForkRef(React45.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React45.isValidElement(children)) {
      ...
      return React45.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime16.jsx)(React45.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime16.jsx)(React45.Fragment, {
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React48.useState(true);
  const hasPendingExitTransition = React48.useRef(false);
  const registeredTransitions = React48.useRef(0);
  const [hasTransition, setHasTransition] = React48.useState(false);
  const previousRequestEnter = React48.useRef(requestEnter);
  React48.useEffect(() => {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React54.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(React59.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React60.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React60.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React60.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var InnerOption = React65.forwardRef(function InnerOption2(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
...
var InnerOptionMemo = React65.memo(InnerOption);
var Option = React65.forwardRef(function Option2(props, ref) {
  const {
    value
  } = props;
  const {
  ...
  return (0, import_jsx_runtime25.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime25.jsx)(InnerOptionMemo, {
      ...props,
      ref
    })
  });
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React69.Fragment, {
...
var Select = React69.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React69.Fragment, {
...
var Slider = React71.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime29.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime29.jsxs)(React71.Fragment, {
...
function useTabs(parameters) {
  ...
  const getTabId2 = React78.useCallback((tabPanelId) => {
...
var TextareaAutosize = React89.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React89.useRef(null);
  const shadowRef = React89.useRef(null);
  const calculateTextareaStyles = React89.useCallback(() => {
  ...
  const syncHeight = React89.useCallback(() => {
  ...
  return (0, import_jsx_runtime40.jsxs)(React89.Fragment, {
...
var LoadingButton = React93.forwardRef(function LoadingButton2(inProps, ref) {
  const contextProps = React93.useContext(ButtonGroupContext_default);
...
var LocalizationProvider = React94.forwardRef(function DeprecatedLocalizationProvider() {
  warn15();
  return null;
});
...
var MobileDatePicker = React95.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn16();
  return null;
});
...
var MobileDateRangePicker = React96.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn17();
  return null;
});
...
var MobileDateTimePicker = React97.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn18();
  return null;
});
...
var MobileTimePicker = React98.forwardRef(function DeprecatedMobileTimePicker() {
  warn19();
  return null;
});
...
var MonthPicker = React99.forwardRef(function DeprecatedMonthPicker() {
  warn20();
  return null;
});
...
var Pagination_default2 = React100.forwardRef(function DeprecatedPagination(props, ref) {
  warn21();
...
var PaginationItem_default2 = React101.forwardRef(function DeprecatedPaginationItem(props, ref) {
  warn22();
...
var CalendarPickerSkeleton = React102.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn23();
  return null;
});
...
var PickersDay = React103.forwardRef(function DeprecatedPickersDay() {
  warn24();
  return null;
});
...
var Rating_default2 = React104.forwardRef(function DeprecatedRating(props, ref) {
  warn25();
...
var Skeleton_default2 = React105.forwardRef(function DeprecatedSkeleton(props, ref) {
  warn26();
...
var SpeedDial_default2 = React106.forwardRef(function DeprecatedSpeedDial(props, ref) {
  warn27();
...
var SpeedDialAction_default2 = React107.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  warn28();
...
var SpeedDialIcon_default2 = React108.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  warn29();
...
var StaticDatePicker = React109.forwardRef(function DeprecatedStaticDatePicker() {
  warn30();
  return null;
});
...
var StaticDateRangePicker = React110.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn31();
  return null;
});
...
var StaticDateTimePicker = React111.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn32();
  return null;
});
...
var StaticTimePicker = React112.forwardRef(function DeprecatedStaticTimePicker() {
  warn33();
  return null;
});
...
var Context = React113.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React113.useState(null);
  React113.useEffect(() => {
...
function useTabContext() {
  return React113.useContext(Context);
}
...
var TabList = React114.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React115.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React116.forwardRef(function DeprecatedTimePicker() {
  warn34();
  return null;
});
...
var TimelineContext = React117.createContext({});
if (true) {
...
var Timeline = React118.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React119.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React120.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
  ...
  } = React120.useContext(TimelineContext_default);
  const ownerState = {
    ...props,
...
var TimelineDot = React121.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
var TimelineOppositeContent = React122.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
...
var TimelineItem = React123.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  const {
    position: positionContext
  } = React123.useContext(TimelineContext_default);
  let hasOppositeContent = false;
  React123.Children.forEach(props.children, (child) => {
...
var TimelineSeparator = React124.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React125.forwardRef(function DeprecatedToggleButton(props, ref) {
  warn35();
...
var ToggleButtonGroup_default2 = React126.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  warn36();
...
var TreeItem = React127.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React128.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
var Masonry = React129.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React129.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React129.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React129.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing,
    columns,
  ...
  const handleResize = React129.useCallback((masonryChildren) => {
...
var DialogsContext = React130.createContext(null);
...
function DialogsProvider(props) {
  ...
  const [stack, setStack] = React132.useState([]);
  const keyPrefix = React132.useId();
  const nextId2 = React132.useRef(0);
  const requestDialog = React132.useCallback(function open(Component, payload, options = {}) {
    const {
      onClose = async () => {
      }
    } = options;
  ...
  const closeDialogUi = React132.useCallback(function closeDialogUi2(dialog) {
  ...
  const closeDialog = React132.useCallback(async function closeDialog2(dialog, result) {
...
function useStorageState(area, key, initializer = null, options) {
  ...
  const [initialValue] = React133.useState(initializer);
  const encodedInitialValue = React133.useMemo(() => encode(codec, initialValue), [codec, initialValue]);
  const subscribeKey = React133.useCallback((callback) => subscribe(area, key, callback), [area, key]);
  const getKeySnapshot = React133.useCallback(() => getSnapshot(area, key) ?? encodedInitialValue, [area, encodedInitialValue, key]);
  const encodedStoredValue = React133.useSyncExternalStore(subscribeKey, getKeySnapshot, getKeyServerSnapshot);
  const storedValue = React133.useMemo(() => decode(codec, encodedStoredValue), [codec, encodedStoredValue]);
  const setStoredValue = React133.useCallback((value) => {
  ...
  const [nonStoredValue, setNonStoredValue] = React133.useState(initialValue);
  if (!key) {
...
function LegacyThemeProvider(props) {
  ...
  const dualAwareTheme = React134.useMemo(() => isDualTheme ? theme[paletteMode === "dark" ? "dark" : "light"] ?? theme[paletteMode === "dark" ? "light" : "dark"] : theme, [isDualTheme, paletteMode, theme]);
  const paletteModeContextValue = React134.useMemo(() => ({
    paletteMode,
...
var AuthenticationContext = React135.createContext(null);
var SessionContext = React135.createContext(null);
...
true ? AppProvider.propTypes = {
   ...
   * @default null
   */
  authentication: import_prop_types43.default.shape({
    signIn: import_prop_types43.default.func.isRequired,
    signOut: import_prop_types43.default.func.isRequired
  }),
  /**
   * Branding options for the app.
   * @default null
   */
  branding: import_prop_types43.default.shape({
    logo: import_prop_types43.default.node,
   ...
   * @default []
   */
  navigation: import_prop_types43.default.arrayOf(import_prop_types43.default.oneOfType([import_prop_types43.default.shape({
    action: import_prop_types43.default.node,
    children: import_prop_types43.default.arrayOf(import_prop_types43.default.oneOfType([import_prop_types43.default.object, import_prop_types43.default.shape({
      kind: import_prop_types43.default.oneOf(["header"]).isRequired,
      title: import_prop_types43.default.string.isRequired
    }), import_prop_types43.default.shape({
      kind: import_prop_types43.default.oneOf(["divider"]).isRequired
    })]).isRequired),
    icon: import_prop_types43.default.node,
    kind: import_prop_types43.default.oneOf(["page"]),
    pattern: import_prop_types43.default.string,
    segment: import_prop_types43.default.string,
    title: import_prop_types43.default.string
  }), import_prop_types43.default.shape({
    kind: import_prop_types43.default.oneOf(["header"]).isRequired,
    title: import_prop_types43.default.string.isRequired
   ...
   * @default null
   */
  router: import_prop_types43.default.shape({
    navigate: import_prop_types43.default.func.isRequired,
    pathname: import_prop_types43.default.string.isRequired,
    searchParams: import_prop_types43.default.instanceOf(URLSearchParams).isRequired
  }),
  /**
   * Session info about the current user.
   * @default null
   */
  session: import_prop_types43.default.shape({
    user: import_prop_types43.default.shape({
      email: import_prop_types43.default.string,
   ...
   * @default window
   */
  window: import_prop_types43.default.object
} : void 0;
...
@mui/lab/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3G4RR6PN.js.map
